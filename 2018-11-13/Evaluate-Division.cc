...
int main() {
    Solution s;
    vector<pair<string, string>> equations(2);
    equations[0] = make_pair("a","b");
    equations[1] = make_pair("b","c");
    
    vector<double> values(2);
    values[0] = 2.0;
    values[1] = 3.0;

    vector<pair<string, string>> queries(5);
    queries[0] = make_pair("a","c");
    queries[1] = make_pair("b","c");
    queries[2] = make_pair("a","e");
    queries[3] = make_pair("a","a");
    queries[4] = make_pair("x","x");

    vector<double> v = s.calcEquation(equations, values, queries);
